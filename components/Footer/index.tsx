        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/Fintara-Logo.png"
                    alt="logo"
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/profile.php?id=61551754011633"
                  ...
                  <a
                    href="https://www.linkedin.com/company/kernel-encode/"
                    aria-label="social-link"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2025 Kernel Encode Pvt Ltd. All rights reserved.
            </p>
            <p className="text-center text-base text-body-color dark:text-white mt-2">
              Designed and Developed with <span role="img" aria-label="love">💙</span> by Kernel Encode Team
            </p>
          </div>
        </div>
